...
run_dir="runs/bimamba_param_matched_seed${seed}"
result_dir="results/bimamba_ablation_multiseed/seed${seed}"
seeded_config="runs/configs/bimamba_param_matched_seed${seed}.json"
...
"$python_bin" scripts/make_seed_config.py \
  --base configs/bimamba_param_matched.json \
  --seed "$seed" \
  --output-dir "$run_dir" \
