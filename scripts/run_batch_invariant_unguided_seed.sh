...
run_dir="runs/batch_invariant_revision/unguided_seed$seed"
result_dir="results/batch_invariant_revision/unguided_retrained/seed$seed"
seeded_config="runs/configs/batch_invariant_unguided_seed$seed.json"
...
"$python_bin" scripts/make_seed_config.py \
  --base configs/dual_bimamba.json --seed "$seed" \
