...
run_variant() {
  ...
  local result_dir="results/key_ablation_multiseed/seed${seed}/${tag}"
...
# Same architecture, data, schedule, and seed.  The first variant removes
# structural gate supervision; the second retains it but removes role/type loss.
run_variant dual_unguided configs/dual_bimamba.json dual_bimamba
run_variant guided_no_semantic_aux configs/dual_bimamba_guided_no_aux.json dual_bimamba_guided_no_aux
